...
(function( $ ) {
    ...
    $.fn.colorPick.defaults = {
        ...
        'palette': ["#ffffff", "#16a085", "#2ecc71", "#27ae60", "#3498db", "#2980b9", "#9b59b6", "#8e44ad", "#34495e", "#2c3e50", "#f1c40f", "#f39c12", "#e67e22", "#d35400", "#e74c3c", "#c0392b", "#ecf0f1", "#bdc3c7", "#95a5a6", "#7f8c8d"],
    ...
    $.colorPick.prototype = {
        ...
        show: function(element, left, top) {
	        ...
	        jQuery.each(this.palette, function (index, item) {
                if (index == 0){
				  $("#colorPick").append('<div class="colorPickButton" hexValue="' + item + '" style="background:linear-gradient(138deg, #ebf95e, #65f540, #2e85b5, #9147b5, #9a41b5, #fd1d1d, #fcb045);"></div>');
                }
                else{
